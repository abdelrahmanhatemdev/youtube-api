...
import { clearHistory, getHistory } from "../../data/historyData";
...
export default function HistoryOptions({setVideos}) {
    ...
    async function handleSearch (e){
        ...
        setVideos(
            videos.filter(data => {
                return data.video.title.toLowerCase().includes(newSearch.toLowerCase())
            })
        )
    }
            ...
            <div className="options">
                <div className='option search'>
                 ...
                 <div className="option" onClick={() => setShowModal(true)}>
                    ...
                    <span className="title">Clear all watch history</span>
                </div>
