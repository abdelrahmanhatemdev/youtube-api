...
export default function Aside() {
    ...
    return (
        <div className={'list ' + (isOpen ? "open" : "")}>
            ...
            <NavLink to="/menu/shorts" className={({isActive})=>  isActive ? "active" : ""}>
                <span className='icon'>
                    <svg>
            ...
            <span className='separator'></span>
            <NavLink to="/menu/history" className={({isActive})=>  isActive ? "active" : ""}>
                <span className='icon'>
                    <svg>
                        <g>
            ...
            <NavLink to="/menu/later" className={({isActive})=>  isActive ? "active" : ""}>
                <span className='icon'>
                    <svg>
